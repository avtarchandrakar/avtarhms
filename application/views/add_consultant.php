                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="first" id="first" class="form-control"  placeholder=" Enter First" required="" >
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>Second<span class="text-danger">*</span></label>
                                 <input type="text" name="second" id="second" class="form-control"  placeholder=" Enter Second" required="" >
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
