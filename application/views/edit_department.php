            ...
            <div class="breadcromb-area">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 pull-right">
                     ...
                     <a style="margin-right: 5px;" href="<?php  echo site_url('Department/department_list'); ?>" class="btn btn-info btn-vsm"><i class="fa fa-long-arrow-left"></i> Back</a>
                  ...
                  <div class="form-wrap top-label-exapmple form-layout-page">
                    <form method= "post" id="frm-update-data">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>Medicine Department<span class="text-danger">*</span></label>
                                 <select name="medi_depart" id="medi_depart" class="form-control select2" title="Select Medicine Department" required>
                                    <option value="No" <?php if($a_value[0]->medi_depart=='No') echo 'selected';?>>No</option>              
                                    <option value="Yes" <?php if($a_value[0]->medi_depart=='Yes') echo 'selected';?>>Yes</option>
                                 </select>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-layout-submit">
                              <a href="<?php echo site_url('Department/department_list') ?>" class="btn btn-block btn-danger">Reset</a>
                              </div>
                           </div>
                        </div>
                     </form>
