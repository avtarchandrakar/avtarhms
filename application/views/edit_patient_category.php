            ...
            <div class="breadcromb-area">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 pull-right">
                     ...
                     <a style="margin-right: 5px;" href="<?php  echo site_url('patient_category/patient_category_list'); ?>" class="btn btn-info btn-vsm"><i class="fa fa-long-arrow-left"></i> Back</a>
                  ...
                  <div class="form-wrap top-label-exapmple form-layout-page">
                    <form method= "post" id="frm-update-data">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>Patient Category Name<span class="text-danger">*</span></label>
                                 <input type="text" name="name" id="name" class="form-control"  placeholder=" Enter Patient Category Name" required="" value="<?php echo $a_value[0]->name;?>">
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-layout-submit">
                              <a href="<?php echo site_url('patient_category/patient_category_list') ?>" class="btn btn-block btn-danger">Reset</a>
                              </div>
                           </div>
                        </div>
                     </form>
...
<?php $this->view('js/js_patient_category') ?>
