                        ...
                        <div class="row">
                           <div class="col-md-8">
                              <div class="form-group">
                                 ...
                                 <input type="hidden" name="m_state_id" value="<?php echo $a_value[0]->id;?>">
                                 <input type="text" name="m_state_name" id="m_state_name" class="form-control"  placeholder=" Enter Name" required="" value="<?php echo $a_value[0]->name;?>">
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
