            ...
            <div class="breadcromb-area">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 pull-right">
                     ...
                     <a style="margin-right: 5px;" href="<?php  echo site_url('Department/tariff_list'); ?>" class="btn btn-info btn-vsm"><i class="fa fa-long-arrow-left"></i> Back</a>
                  ...
                  <div class="form-wrap top-label-exapmple form-layout-page">
                    <form method= "post" id="frm-update-data">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-layout-submit">
                              <a href="<?php echo site_url('Department/tariff_list') ?>" class="btn btn-block btn-danger">Reset</a>
                              </div>
                           </div>
                        </div>
                     </form>
