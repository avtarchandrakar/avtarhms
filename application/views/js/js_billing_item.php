<script type="text/javascript"> $(document).ready(function(e){
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('Billing_items/insert_billing_items'); ?>",
    data: formData,
    processData: false,
    contentType: false,
    dataType: "JSON", 
    success: function(data) {
      ...
      if(data.status=='success'){
        ...
        setTimeout(function(){
          window.location = "<?php echo site_url('Billing_items/billing_item_form'); ?>"; 
        },1000);
...
$("form#frm-update-data").submit(function(e) { e.preventDefault();
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('Billing_items/update_billing_item'); ?>",
    data: formData,
    processData: false,
    contentType: false,
    dataType: "JSON", 
...
$("#custom_tbl").on("click",".delete-data",function(){ 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Billing_items/delete_billing_item'); ?>",
